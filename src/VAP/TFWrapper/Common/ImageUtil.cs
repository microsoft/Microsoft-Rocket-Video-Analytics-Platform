...
namespace Wrapper.TF.Common
{
	public static class ImageUtil
	{
        ...
        // Convert byte[] to a Tensor suitable as input to the Inception model.
        public static TFTensor CreateTensorFromByteArray(byte[] imageByteArray, TFDataType destinationDataType = TFDataType.Float)
        {
